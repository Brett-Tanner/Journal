...
- Teacher Features
  - [] Student profile
- School Manager features
  - [] Student list
  - [] Moving students between classes
- Curriculum Team features
  - [] Creating an autogenerated PDF from a lesson
  - [] Proposing changes
- OrgAdmin features
  - [] Creating schools
  - [] Creating and linking teachers/classes
...
- [] Create the resource
- [] Add factory & model spec
  - [] Add parent_id to Child
- [] Write a system spec for an SM creating one
...
- Should be able to print report cards for each result as a PDF
  - From a separate test results page
    - [] So main page should only show those for the most recent level
  - Do this on the page with CSS
  - Create parent accounts so they can log in and print it themselves

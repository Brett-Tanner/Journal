...
- [x] Use `pnpm` for this one instead
- [x] Write API call and check them by console logging
- [x] Process the response into something I can use
- [x] Add a form to trigger the API calls
- [] Display the info
  - [] Card
  - [] Change theme when the weather changes
